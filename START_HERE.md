...
### 🌟 方案 1: 云服务快速启动 (推荐 - 5 分钟)

**无需 Docker，使用免费云服务**

1. 获取云数据库
   - [Supabase](https://supabase.com/) - PostgreSQL (1 分钟)
   - [Upstash](https://upstash.com/) - Redis (1 分钟)
...
### 🐳 方案 2: Docker 本地启动 (需要 Docker Desktop)
...
在 Windows 上直接安装 PostgreSQL 和 Redis

**完整指南**: [SETUP_WITHOUT_DOCKER.md](./SETUP_WITHOUT_DOCKER.md)
