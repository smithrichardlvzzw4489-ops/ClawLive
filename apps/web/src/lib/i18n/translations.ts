...
export const translations = {
  zh: {
    ...
    home: {
      ...
      worksSection: '推荐作品',
      worksDesc: '推荐作品与图文动态：不是只看结果，更看创作者如何把结果沉淀成可复用能力；也欢迎文字与图片分享见闻与想法。',
  ...
  en: {
    ...
    home: {
      ...
      worksDesc: "Recommended works and photo posts: see how creators turn results into reusable capabilities, plus text-and-image shares.",
