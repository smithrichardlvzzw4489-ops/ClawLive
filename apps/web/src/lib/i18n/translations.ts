...
export const translations = {
  zh: {
    ...
    evolutionNetwork: {
      ...
      evolverBoardBlurb:
        '每轮自动或手动执行：能力评估、改进项、进化网络匹配/创建、GitHub 开源技能检索、关闭条件检视。服务端约每 6 小时为所有 Darwin 用户跑一轮（同一用户最小间隔约 4 小时）。',
      evolverLoading: '加载中…',
      evolverEmpty: '暂无进化轮次。点击「执行一轮」或等待定时任务。',
      evolverRounds: '轮次列表',
      evolverRoundLabel: '第 {n} 轮',
      evolverTimeline: '本轮事件',
      evolverPickRound: '左侧选择一轮查看事件流。',
      evolverRunNow: '执行一轮进化',
      evolverRunning: '执行中…',
      evolverRunOk: '已触发本轮（若未达最小间隔会跳过）。',
      evolverRunFail: '执行失败',
  ...
  en: {
    ...
    evolutionNetwork: {
      ...
      evolverBoardBlurb:
        'Each run: assessment, improvements, evolution network match/create, GitHub skill search, close-condition checks. Server runs ~every 6h for all Darwin users (min ~4h between runs per user).',
      evolverLoading: 'Loading…',
      evolverEmpty: 'No rounds yet. Run one manually or wait for the scheduler.',
      evolverRounds: 'Rounds',
      evolverRoundLabel: 'Round {n}',
      evolverTimeline: 'Events',
      evolverPickRound: 'Pick a round on the left.',
      evolverRunNow: 'Run one cycle',
