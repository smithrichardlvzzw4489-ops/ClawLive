...
export const translations = {
  zh: {
    ...
    feedPost: {
      ...
      coverImageHint: '仅 1 张，比例 3:4（与首页作品卡片一致），单张不超过 5MB；选择后请裁剪',
      ...
      summaryTitle: '摘要',
      bodySectionTitle: '正文',
      markdownHint: '正文支持 Markdown：标题、列表、链接、表格、代码块等',
      titleCount: '{n}/120',
  ...
  en: {
    ...
    feedPost: {
      ...
      coverImageHint: 'One image only, 3:4 ratio (same as feed cards), max 5MB; crop after selection',
      ...
      markdownHint: 'Markdown supported: headings, lists, links, tables, code blocks, etc.',
      titleCount: '{n}/120',
