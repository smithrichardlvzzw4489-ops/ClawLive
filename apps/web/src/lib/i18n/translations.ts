...
export const translations = {
  zh: {
    ...
    nav: {
      ...
      personaRecruiterBadge: '招聘方：我的画像入口已隐藏',
      personaSwitchDeveloper: '求职者',
      personaSwitchRecruiter: '招聘方',
      switchPersona: '切换身份',
      choosePersonaHome: '首页选择身份',
      personaUnsetBadge: '请先在首页选择「求职者」或「招聘方」',
    ...
    personaEntry: {
      ...
      recruitersBody:
        '建议关注：招聘管理发布与维护 JD；站内信与候选人联系；职位页展示 JD；主页「三入口」用于人才检索与触达。',
    ...
    evolutionNetwork: {
      ...
      evolverRunning: '执行中…',
      evolverRunOk: '已尝试立即执行（若距上一轮不足约 24 小时会跳过）。',
      evolverRunFail: '执行失败',
    ...
    auth: {
      ...
      networkError: '无法连接服务器。本地请确认后端已启动（默认端口 3001）；线上请稍后重试或检查网络。',
      avatarLabel: '头像',
  ...
  en: {
    ...
    nav: {
      ...
      personaRecruiterBadge: 'Hiring: my card link hidden',
      personaSwitchDeveloper: 'Job seeker',
      personaSwitchRecruiter: 'Hiring',
      switchPersona: 'Switch identity',
      choosePersonaHome: 'Choose on home',
      personaUnsetBadge: 'Pick job seeker or hiring on the home page first',
    ...
    personaEntry: {
      ...
      recruitersBody:
        'Use recruitment to manage JDs, messages to reach candidates, the jobs page for visibility, and the home “triple entry” for talent search and outreach.',
    ...
    evolutionNetwork: {
      ...
      evolverRunOk: 'Cycle triggered (skipped if less than 24 hours since the last round).',
    ...
    auth: {
      ...
      networkError: 'Cannot connect to the server. Locally, ensure the backend is running (default port 3001); online, retry or check your network.',
