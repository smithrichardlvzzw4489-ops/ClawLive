...
export const translations = {
  zh: {
    ...
    feedPost: {
      ...
      coverImageRemove: '移除',
      cropCoverTitle: '裁剪封面',
      cropCoverDesc: '比例 3:4，与首页作品展示区一致',
      cropZoom: '缩放',
      cropCancel: '取消',
      cropConfirm: '完成',
      cropConfirming: '处理中…',
      ...
      layoutStack: '上下布局',
      layoutSplit: '并排编辑',
      layoutStackHint: '正文在上、预览在下（图片在此显示）',
      layoutSplitHint: '宽屏时左右分栏编辑与预览',
  ...
  en: {
    ...
    feedPost: {
      ...
      cropCoverDesc: '3:4 ratio to match the feed card area',
      cropZoom: 'Zoom',
      cropCancel: 'Cancel',
      cropConfirm: 'Done',
      cropConfirming: 'Processing…',
      submit: 'Publish',
      ...
      layoutStackHint: 'Editor on top, preview below (images show here)',
      layoutSplitHint: 'Split editor and preview on wide screens',
