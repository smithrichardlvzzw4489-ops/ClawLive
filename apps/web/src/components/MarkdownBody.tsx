...
export function MarkdownBody({ content, className = '' }: { content: string; className?: string }) {
  ...
  return (
    <div
      className={`markdown-body prose prose-lg prose-gray max-w-none text-pretty antialiased ${fontClass} prose-headings:scroll-mt-24 prose-headings:font-semibold prose-headings:tracking-tight prose-p:leading-[1.75] prose-li:leading-relaxed prose-blockquote:border-l-lobster/40 prose-blockquote:font-normal prose-a:font-medium prose-img:mx-auto ${className}`}
    >
